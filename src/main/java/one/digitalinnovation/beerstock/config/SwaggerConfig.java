...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Adayane Coutinho";
    private static final String CONTACT_GITHUB = "https://gtihub.com/adayanecoutinho";
    private static final String CONTACT_EMAIL = "adayanencl@gmail.com";
